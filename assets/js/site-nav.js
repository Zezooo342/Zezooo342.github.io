...
(function() {
    ...
    function injectFooter() {
        ...
        const footerNavHTML = siteIndex ? 
            createFooterNavigation(siteIndex.pages) + baseFooter : 
            baseFooter;
    ...
    function loadSEOHelper() {
        // Dynamically load SEO helper once per page
        const existing = document.querySelector('script[data-seo-helper]');
        if (existing) return;
        const s = document.createElement('script');
        s.src = '/assets/js/seo.min.js';
        s.defer = true;
        s.setAttribute('data-seo-helper', 'true');
